...
class Operative:
    ...
    def guard_act(self):
hacker = Operative(hack_name, "HACKER", random.randint(2, 5), random.randint(6, 8), random.randint(3, 5), random.randint(2, 6), [False, False, False, False])
special_op = Operative(ops_name, "SPECIAL OP", random.randint(6, 8), random.randint(3, 6), random.randint(4, 6), random.randint(1, 3), [False, False, False, False])
saboteur = Operative(sab_name, "SABOTEUR", random.randint(3, 5), random.randint(1, 3), random.randint(6, 8), random.randint(5, 7), [False, False, False, False])
mechanic = Operative(mec_name, "MECHANIC", random.randint(3, 5), random.randint(3, 5), random.randint(3, 5), random.randint(3, 5), [False, False, False, False])
...
if bunk_choice == "1":
    ...
    if flashvar == "1":
        hacker.skills_showcase(1)
        special_op.skills_showcase(1)
        saboteur.skills_showcase(1)
        mechanic.skills_showcase(1)
        char_choice = input("Who should throw the flash? (1/2/3/4) ")
